...
spells.each do |spell|
  new_spell = Spell.new(
    ...
    school: spell[:school], 
    dnd_class: spell[:class]
  )

  # spell level conversion
  lvl_num = spell[:level][0].to_i
  new_spell.level = lvl_num

  # adding higher_level description
  if spell[:higher_level]
    new_spell.higher_lvl = spell[:higher_level]
  else
    new_spell.higher_lvl = nil
  end
